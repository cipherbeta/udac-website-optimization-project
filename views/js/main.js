...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var documentPizzaContainer = document.querySelectorAll(".randomPizzaContainer");

    for (var i = 0; i < documentPizzaContainer.length; i++) {
      documentPizzaContainer[i].style.width = newWidth + "%";
    }
  }
